...
import styles from './TokenAccessTestWebPart.module.scss';
import * as strings from 'TokenAccessTestWebPartStrings';
import { MSGraphClientV3 } from '@microsoft/sp-http';
import * as MicrosoftGraph from '@microsoft/microsoft-graph-types';

export interface ITokenAccessTestWebPartProps {
  description: string;
}

export default class TokenAccessTestWebPart extends BaseClientSideWebPart<ITokenAccessTestWebPartProps> {
  ...
  public render(): void {
    ...
    .then((client: MSGraphClientV3): void => {
      ...
      .get((error, messages: any) => {
        ...
        <div class="${styles.tokenAccessTest}">
          <div>
